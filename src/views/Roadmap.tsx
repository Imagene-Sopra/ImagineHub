...
export const Roadmap: React.FC = () => {
  ...
  const handleSaveTask = async (data: { titulo: string; descripcion: string; tags: string[]; fechaInicio?: string; fechaFin?: string; estimacion?: number; tipo?: "PoC" | "Presentation" | "Run" | "Build" | "" }) => {
